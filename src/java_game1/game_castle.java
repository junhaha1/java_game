...
public class game_castle extends JFrame{
	...
	private JLabel res1 = new JLabel("금");
	private JLabel res2 = new JLabel("쌀");
	private JLabel res3 = new JLabel("특산물");
	
	private JTextField res11 = new JTextField();
	private JTextField res22 = new JTextField();
	private JTextField res33 = new JTextField();
	
	private JButton info2_btn1 = new JButton("무장");
	private JButton info2_btn2 = new JButton("닫기");
